...
// Shopify webhook secret (you need to set this in your Shopify app settings)
const SHOPIFY_WEBHOOK_SECRET = process.env.SHOPIFY_WEBHOOK_SECRET || "your_webhook_secret_here";
...
app.listen(PORT, () => {
  ...
  console.log(`⚠️  Recuerda configurar SHOPIFY_WEBHOOK_SECRET en las variables de entorno`);
});